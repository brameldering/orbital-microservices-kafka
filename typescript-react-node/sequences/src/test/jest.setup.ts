...
// ================== Mock kafka.js ====================
import '@orbitelco/common/build/__mocks__/kafkajs';
...
jest.mock(
  '../../node_modules/@orbitelco/common/build/kafka/base-publisher',
  () => {
    return jest.requireActual(
      '../../node_modules/@orbitelco/common/build/__mocks__/base-publisher'
    );
  }
);
