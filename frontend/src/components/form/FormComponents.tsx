...
const FormComponent: React.FunctionComponent<FormikComponentProps> = ({
  controlId,
  label,
  type,
  formik,
...
const TextField: React.FunctionComponent<FormikFieldProps> = ({
  controlId,
  label,
  formik,
}) => {
...
const EmailField: React.FunctionComponent<FormikFieldProps> = ({
  controlId,
  label,
  formik,
}) => {
...
const NumberField: React.FunctionComponent<FormikFieldProps> = ({
  controlId,
  label,
  formik,
}) => {
...
const CheckBoxField: React.FunctionComponent<FormikFieldProps> = ({
  controlId,
  label,
  formik,
}) => {
...
const HiddenTextField: React.FunctionComponent<FormikHiddenFieldProps> = ({
  controlId,
  formik,
}) => {
  return (
...
const PasswordField: React.FunctionComponent<FormikFieldProps> = ({
  controlId,
  label,
  formik,
}) => {
